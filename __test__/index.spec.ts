...
import { attach, detach } from '@jolocom/wallet-rs'
...
test('attach wallet from native code', (t) => {
  t.notThrows(alice_wallet.att(alice_string, "alice", "alice"))
})

test('sleep function from native code', async (t) => {
  t.notThrows(alice_wallet.det(new Buffer("alice", 'utf-8').toString('base64')))
})
